...
export default function Create() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post('/admin/adminpanel/users/create');
  };

  return (
    <>
      <title>Create User | Diro</title>
      <Navbar />
        ...
        <div className="bg-gradient-to-b from-[#F5F5F5] to-white py-16 px-8 mb-12">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="font-[Quicksand] font-bold text-5xl mb-4">
              Create <span className="text-[#D1D3D4]">User</span>
            </h1>
        ...
        <div className="max-w-2xl mx-auto px-8">
          <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-[#F5F5F5]">
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div>
                <label htmlFor="password" className="font-[Quicksand] font-semibold text-base mb-3 block">
                  Password
                </label>
                <input
                  type="password"
